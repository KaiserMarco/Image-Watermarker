...
LFLAGS = -lstdc++fs -pthread -L//home/marco/Scrivania/CImg-2.2.3/CImg.h
OBJ = Appoggio.o Node.o Emitter.o Worker.o Collector.o Message.o Queuet.o Timer.o
...
Appoggio.o: Appoggio.cpp Emitter.h Worker.h Collector.h Queuet.h Timer.h 
	$(CC) $(CFLAGS) $(LFLAGS) Appoggio.cpp
...
Collector.o: Collector.cpp Collector.h Node.h Message.h
